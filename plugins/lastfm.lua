...
function lastfm:init()
	...
	lastfm.triggers = utilities.triggers(self.info.username):t('lastfm', true):t('lm', true):t('fmset', true).table
end
...
/fmset <username>
Sets your last.fm username. Otherwise, /lm will use your Telegram username. Use "/fmset --" to delete it.
```]]
